...
Private Sub DataOk()
      Formlocal.txtnotaris = RSnotaris!kode_notaris
      Formlocal.txtnamanot = RSnotaris!nama_notaris
      Call Formlocal.CariDatanot
    MDIForm1.Enabled = True
    Unload Me
End Sub
