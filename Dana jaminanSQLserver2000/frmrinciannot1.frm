...
Begin VB.Form frmrinciannot1 
   BackColor       =   &H00C00000&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Rincian Notaris"
   ClientHeight    =   1410
   ClientLeft      =   5580
   ClientTop       =   5115
   ClientWidth     =   3960
   Icon            =   "frmrinciannot1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmrinciannot1"
...
Private Sub cmdcetak_Click()
  Cr.ReportFileName = App.Path & "\REPORT RINCIAN BIAYA NOTARIS YANG BELUM DIBAYAR.rpt"
  Cr.WindowTitle = "REPORT RINCIAN BIAYA NOTARIS YANG BELUM DIBAYAR"
