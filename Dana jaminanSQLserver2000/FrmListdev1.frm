...
Private Sub DataOk()
      frmdev.txtdev = RSdeveloper!kode_developer
      frmdev.txtnamadev = RSdeveloper!nama_developer
      Call frmdev.CariDatadev
    MDIForm1.Enabled = True
    Unload Me
End Sub
