...
Begin VB.Form frmrinciannot2 
   BackColor       =   &H00C00000&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Rincian APHT"
   ClientHeight    =   1410
   ClientLeft      =   5580
   ClientTop       =   5115
   ClientWidth     =   3960
   Icon            =   "frmrinciannot2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmrinciannot2"
...
Private Sub cmdcetak_Click()
  Cr.ReportFileName = App.Path & "\REPORT RINCIAN BIAYA APHT YANG BELUM DIBAYAR.rpt"
  Cr.WindowTitle = "REPORT RINCIAN BIAYA APHT YANG BELUM DIBAYAR"
