...
Private Sub DataOk()
      frmrinciannot2.txtnot = RSnotaris!kode_notaris
      frmrinciannot2.txtnamanot = RSnotaris!nama_notaris
      Call frmrinciannot2.CariDatanot
    MDIForm1.Enabled = True
    Unload Me
End Sub
