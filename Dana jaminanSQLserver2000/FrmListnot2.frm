...
Private Sub DataOk()
      frmrinciannot1.txtnot = RSnotaris!kode_notaris
      frmrinciannot1.txtnamanot = RSnotaris!nama_notaris
      Call frmrinciannot1.CariDatanot
    MDIForm1.Enabled = True
    Unload Me
End Sub
