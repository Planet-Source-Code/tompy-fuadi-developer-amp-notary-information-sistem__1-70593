...
Private Sub DataOk()
      frmnot.txtnot = RSnotaris!kode_notaris
      frmnot.txtnamanot = RSnotaris!nama_notaris
      Call frmnot.CariDatanot
    MDIForm1.Enabled = True
    Unload Me
End Sub
